...
ggplot(aes(x = period, group = Towngroup), 
       data = subset(gh_sum,period >= 1960 & period <= 2010)) + 
#  geom_linerange(aes(ymin = min, ymax = max, colour = Towngroup)) + 
#  geom_point(aes(colour = Towngroup)) + 
  geom_ribbon(aes(ymin=min, ymax=max, y = median, fill = Towngroup), alpha = 0.5) + 
  geom_line(aes(y = median, colour = Towngroup)) + 
  annotate("text", x = 2008, y = 30000, label ="Hartford: $28,970", size = 3) +
  annotate("text", x = 2008, y = 115000, label ="Simsbury: $113,224", size = 3) +
  annotate("text", x = 2008, y = 45000, label ="East Hartford: $48,613", size = 3) +
  annotate("text", x = 1970, y = 8500, label ="Hartford: $9,108", size = 3) +
  annotate("text", x = 1970, y = 18000, label ="Simsbury: $17,186", size = 3) +
  annotate("text", x = 1970, y = 12300, label ="East Hartford: $11,771", size = 3) +
  scale_y_continuous(labels = comma, lim = c(0,125000)) + 
